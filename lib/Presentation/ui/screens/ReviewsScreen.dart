...
class _ReviewScreenState extends State<ReviewScreen> {
  ...
  final TextEditingController ratingTextEditingController = TextEditingController();
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10,),
                      Center(
                        child: Text("Rating : ${countRate.toString()}",style: const TextStyle(
                          fontSize: 15,
                          letterSpacing: .5,
                        ),),
                      ),
                      ...
                      GetBuilder<CreateProductReviewController>(
                          builder: (createReviewController) {
                            return Visibility(
                              visible: !createReviewController.createProductReviewInProgress,
                                ...
                                child: ElevatedButton(
                                    onPressed: (){
                                      if (_formKey.currentState!.validate()){
                                        createReviewController.createProductReview(
