...
//
// import '../widgets/home/card_product_card.dart';
...
//                 Expanded(
//
//                    child: ListView.builder(itemCount:cartListController.cartListModel.data?.length?? 0, itemBuilder: (context, index){
...
//                           onPressed: ()   {
//                             // if( await Get.find<ReadProfileController>().readProfileData() == false){
...
import 'package:ecommerce/Presentation/state_holders/read_profile_controller.dart';
import 'package:ecommerce/Presentation/ui/utility/app_colors.dart';
import 'package:ecommerce/Presentation/ui/widgets/home/card_product_card.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
